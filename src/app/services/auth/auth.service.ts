...
export class AuthService {
  ...
  private path= 'https://app-homwork-angular.herokuapp.com:8080/api/users/'
  private pathFindByName= 'https://app-homwork-angular.herokuapp.com:8080/api/users/get-user'
